...
{ id: "CountWidget-2", x: 0, y: 1, h: 2, w:1, componentName:"File Count",component:"CountWidget",Props:{count:20} },
{ id: "TextWidget-3", x: 1, y: 1, h: 2, w:2, componentName:"Status",component:"TextWidget",Props:{displayText:"Published"}}] : 
